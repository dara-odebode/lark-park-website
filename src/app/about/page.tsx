...
export default function HomePage() {
  ...
  return (
    <main className="flex flex-col text-center bg-[#F3EAE5] px-9">
      ...
      {/* Description section */}
      <div className="bg-[#77211F] p-6 md:p-8 mt-8 pb-24 flex flex-col min-h-[580px] md:min-h-67 md:h-69 md:flex-row items-center md:items-start justify-between gap-6">
