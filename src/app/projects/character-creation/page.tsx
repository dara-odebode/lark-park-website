...
export default function HomePage() {
  ...
  return (
    <main className="flex flex-col text-center px-9 bg-[#77211F] mb-0.5">
      ...
      <h1 className="text-2xl md:text-4xl text-[#F3EAE5] font-bold mt-20 md:mt-15 text-left leading-snug px-4 md:px-8 tracking-wide">
      ...
      <div className="flex flex-col md:flex-row w-full px-4 md:px-10 mt-6 mb-25 gap-10 text-left">
        ...
        {/* image */}
        <div className="relative w-full md:w-150 h-50 md:h-80 flex-shrink-0 overflow-hidden">
          <Image
